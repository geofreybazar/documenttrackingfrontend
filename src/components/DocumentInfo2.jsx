...
import { Table, TableBody, TableContainer, TableHead, TableRow, Paper, Box, IconButton, Tooltip } from '@mui/material/';
...
function DocumentInfo({clickeDocument, clickedPendingDocument, setEditDocument, isLoading, setIsLoading, myDocumentClickedDocument }) {
                            ...
                            <TableBody>
                                {document?.historylog.map((logs, index) => (
                                    ...
                                    <StyledTableCell>
                                        ...
                                        : logs.receivedBy 
                                        ? `The Document was received by: ${logs.receivedBy}`
                                        : `The Document was forwarded by ${logs.from} to ${logs.to}`}
                                    </StyledTableCell>
                                    </StyledTableRow>
                                ))}
                            </TableBody>
